...
df.add_system_transition(State.PROMPT_oolonlinereason_prodbad1,State.PROMPT_oolstudyspot1,r'[!"True true. I miss studying at coffee shops where I can focus better."#school_e2_online2_loprod"Where is your study area at home?"]')
df.add_system_transition(State.PROMPT_oolonlinereason_socialbad1,State.PROMPT_oolstudyspot1,r'[!"Same."#school_e2_online2_lesssocial"I do not feel as connected to people even though I could see their faces. Where do you usually study at home?"]')
df.add_system_transition(State.PROMPT_oolonlinereason_flexbad1,State.PROMPT_oolstudyspot1,r'[!"To be honestly I struggle with self discipline lately too.Where is your study area at home?"]')
df.add_system_transition(State.PROMPT_oolonline_dislike_err1,State.PROMPT_oolstudyspot1,r'[!"I know. I miss hanging out with my friends in school. Where do you usually study at home?"]')
df.add_system_transition(State.PROMPT_oolonline_like_err1,State.PROMPT_oolstudyspot1,r'[!"I think that part about online learning is great too. Where do you usually study at home?"]')
df.add_system_transition(State.PROMPT_oolonlinereason_flexgood1,State.PROMPT_oolstudyspot1,r'[!"I do manage my time a lot better now that I can listen to lectures whenever I want. Where is your study area at home? "]')
df.add_system_transition(State.PROMPT_oolonlinereason_prodgood1,State.PROMPT_oolstudyspot1,r'[!"There are indeed fewer sources of distractions at home."#school_e2_online2_hiprod"Do you have a study area at home that helps you stay focused ?"]')
df.add_system_transition(State.PROMPT_oolonlinereason_socialgood1,State.PROMPT_oolstudyspot1, r'[!"As an introvert,"##school_e2_online2_socialstress"I am so glad that I do not need to feel stressed about participation in class anymore...Where do you usually study at home?"]')
