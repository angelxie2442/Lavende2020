...
df.add_system_transition(State.PROMPT8_sports,r'[!"Oh yes! I am very sporty too."$activity"is one of my favorite sports! I often wonder why I feel so relaxed after playing it...speaking of that, I gotta go ask my friends to see if they want to practice"$activity"this weekend!"]')
