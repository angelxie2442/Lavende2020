...
df.add_system_transition(State.PROMPT8_art1, State.PROMPT9_1,r'[!"I did not know that you are an artist! I hope I am more artistic... I am gonna go indulge myself in some watercolor painting later'
                                                             r'"]')
df.add_user_transition(State.PROMPT8_1, State.PROMPT8_food1, r'<$activity={[!#ONT(ontfood)]}>')
df.add_system_transition(State.PROMPT8_food1, State.PROMPT9_1,r'[!"Are you a professional foodie? You need to give me some recommendations for restaurants next time!"]')
...
df.add_system_transition(State.PROMPT8_shopping1, State.PROMPT9_1,r'[!"Shopping is super duper relaxing for me too. I always end up feeling so guilty for spending money afterward but I guess it is worth it."]')
...
df.add_system_transition(State.PROMPT8_social1, State.PROMPT9_1,r'[!"You are such a social butterfly! Glad that you have so many friends!"]')
...
df.add_system_transition(State.PROMPT0_schoolgeneral_savage, State.PROMPT_oolpast1,r'[!"Hey that is ok. Are you even living a real college life if you are not struggling? How did you do in terms of"#help_ss"in the past?"]')
df.add_system_transition(State.PROMPT0_schooltime_savage,State.PROMPT_oolgoal1,r'[!"I wonder if i will ever figure out a way to balance work with social life by the time I graduate. Do you worry more about your present life or the future one?"]')
...
df.add_system_transition(State.PROMPT_forclass_err1,State.PROMPT_oolfreq1,r'[!#school_n5_notformajor"Are you trying to raise your stress tolerance with that"$S_S"? How often do you have"#det_ss"like that?"]')
...
df.add_system_transition(State.PROMPT_oolfreq_often1,State.PROMPT_oolstressfr1,r'[!"Do you have"#det_ss"so often that"#school_n1_often"getting stressed about"#det_ss"has become a habit of yours? How often do you find"#help_ss"stressful?"]')
...
df.add_system_transition(State.PROMPT_oolgoal_err1,State.PROMPT_oolgoalalign1,r'[!"It is too hard for me to control the future so I onlt focus on the present."#school_n4_present"How much do you think your current priorities matter for your life, say, four years later?"]')
df.add_system_transition(State.PROMPT_oolgoal_re1,State.PROMPT_oolgoalalign1,r'[!"You want to be the author of your own life story!"#school_n4_future"How much do you think your current tasks align with goals you wish to accomplish, say, four years later, then?"]')
...
df.add_system_transition(State.PROMPT_oolgoalalign_err1,State.PROMPT_oolstressfr1,r'[!"I see. Currently I am working on how to care less about my future goals so I do not get stressed about time management all the time."#school_n4_lil"How often do you find"#help_ss"overwhelming?"]')
df.add_system_transition(State.PROMPT_oolgoalalign_yes1,State.PROMPT_oolstressfr1,r'[!"Do not forget to stop and smell the flowers too!"#school_n4_much"I keep forgetting about that when I constantly focus on trying to prepare for all possible future outcomes. How often do you find"#help_ss"overwhelming?"]')
df.add_system_transition(State.PROMPT_oolgoalalign_no1,State.PROMPT_oolstressfr1,r'[!"Interesting.I have rarely met anyone that is concerned about time management but not so much about accomplishing future goals."#school_n4_lil".How often do u find"#help_ss"overwhelming?"]')
...
df.add_system_transition(State.PROMPT_oolonlinereason_flexgood1,State.PROMPT_oolstudyspot1,r'[!"Do you have a hard time distinguishing weekdays from weekends? Morning from nights? Where is your study area at home? "]')
...
df.add_system_transition(State.PROMPT_oolzoom_yes1,State.PROMPT8_1,r'[!"I guess"#school_e3_studyspot2_zoom"we are quite similar in our study habits. I recently feel so stressed about many things. What do you do to destress during quarantine?"]')
...
df.add_system_transition(State.PROMPT0_schooltime_agg,State.PROMPT_oolgoal2,r'[!"It is always really challenging for me to figure out what I should prioritize the most in my life. Present happiness and future happiness, which one matters more to you?"]')
#schoolevent branch up to stress-freq prompt
...
df.add_system_transition(State.PROMPT_oolfreq_often2,State.PROMPT_oolstressfr2,r'[!"Oh god. I can never imagine myself dealing with"#det_ss"that often."#school_n1_often"How often do you find"#help_ss"stressful?"]')
...
df.add_system_transition(State.PROMPT_oolfreq_sometimes2,State.PROMPT_oolstressfr2,r'[!"Glad you only have to deal with"#det_ss"once in a while."#school_n1_sometimes"How often do you find"#help_ss"stressful? "]')
...
df.add_system_transition(State.PROMPT_oolfreq_err2,State.PROMPT_oolstressfr2,r'[!"I see I see."#school_n1_sometimes"Just curious, how often do you feel stressed about"#help_ss"?"]')
#schoolcourse branch up to stress-freq prompt
...
df.add_system_transition(State.PROMPT_oolpast_err2,State.PROMPT_oolstressfr2,r'[!"I see. I tend to extrapolate what happened in the past to the future."#help_ss"How often"#school_n3_well"do you find"#help_ss"stressful?"]')
df.add_system_transition(State.PROMPT_oolpast_bad2,State.PROMPT_oolstressfr2,r'[!"Perhaps your past experience might have made you too scared to"#ool_or_eer"."#school_n3_bad"How often do you feel stressed about"#help_ss"?"]')
df.add_system_transition(State.PROMPT_oolpast_well2,State.PROMPT_oolstressfr2,r'[!"It is totally understandable that"#school_n3_well"you want to keep your winning streak in"#help_ss"How often do you feel stressed about"#help_ss"?"]')
#schooltime branch up to stress-freq prompt
...
df.add_system_transition(State.PROMPT_oolgoal_re2,State.PROMPT_oolgoalalign2,r'[!"Very Ambitious!"#school_n4_future"How much do you think your current priorities matter to your future goals then?"]')
df.add_system_transition(State.PROMPT_oolgoal_err2,State.PROMPT_oolgoalalign2,r'[!"Yeah I do feel more peaceful when I can just focus on the present"#school_n4_present"How much do you think your current tasks align with your future goals then ?"]')
...
df.add_system_transition(State.PROMPT_oolgoalalign_err2,State.PROMPT_oolstressfr2,r'[!"That is usually how I prioritize my tasks too."#school_n4_lil"How often do you find"#help_ss"overwhelming?"]')
...
df.add_system_transition(State.PROMPT_oolgoalalign_no2,State.PROMPT_oolstressfr2,r'[!"I am like that too. Life gets boring if all one does is pursuing one goal after another."#school_n4_lil"How often do u find"#help_ss"overwhelming?"]')
...
df.add_system_transition(State.PROMPT_oolonline_dislike_err2,State.PROMPT_oolstudyspot2,r'[!"Finger crossed. I really hope that we can go back to school this fall. Where do you usually study at home?"]')
...
df.add_system_transition(State.PROMPT_oolzoom_yes2,State.PROMPT8_1,r'[!"I guess"#school_e3_studyspot2_zoom"we are quite similar in our study habits. I recently feel so stressed about many things. What do you do to destress during quarantine?"]')
df.add_system_transition(State.PROMPT_oolzoom_err2,State.PROMPT8_1,r'[!"Interesting. What do you do to destress during quarantine?"]')
############END OF SCHOOL AGG###################################################################
...
df.add_system_transition(State.PROMPT_oolfreq_often3,State.PROMPT_oolstressfr3,r'[!"You will deinitely become so intelligent after dealing with"#det_ss"that often."#school_n1_often"How often do you find"#help_ss"stressful?"]')
...
df.add_system_transition(State.PROMPT_oolfreq_sometimes3,State.PROMPT_oolstressfr3,r'[!"I guess you will gradually get used to the stress it brings."#school_n1_sometimes"How often do you find"#help_ss"stressful? "]')
...
df.add_system_transition(State.PROMPT_oolfreq_err3,State.PROMPT_oolstressfr3,r'[!"I am sure the more experience you get with that"$S_S"the less stressful it will be for you in the future!"#school_n1_sometimes"Just curious, how often do you feel stressed about"#help_ss"?"]')
#schoolcourse branch up to stress-freq prompt
...
df.add_system_transition(State.PROMPT_oolpast_err3,State.PROMPT_oolstressfr3,r'[!"If you keep trying, things will definitely turn out really well in the end!"#school_n3_well"How often do you find"#help_ss"stressful?"]')
df.add_system_transition(State.PROMPT_oolpast_bad3,State.PROMPT_oolstressfr3,r'[!"What happened in the past is just a small part of the marathon to pursue the people or things that you love. Hang in there!"#school_n3_bad"How often do you feel stressed about"#help_ss"?"]')
df.add_system_transition(State.PROMPT_oolpast_well3,State.PROMPT_oolstressfr3,r'[!"Then"#school_n3_well"you will do well in"#help_ss"again this time! I have faith in you. How often do you feel stressed about"#help_ss"?"]')
#schooltime branch up to stress-freq prompt
...
df.add_system_transition(State.PROMPT_oolgoal_re3,State.PROMPT_oolgoalalign3,r'[!"It is always helpful to have a vision for the future."#school_n4_future"How much do you think your current priorities are related to your future goals?"]')
df.add_system_transition(State.PROMPT_oolgoal_err3,State.PROMPT_oolgoalalign3,r'[!#school_n4_present"The future is way beyond our control. I think it is wise to avoid wasting too much effort thinking about the future. How much do you think your current tasks align with your future goals then ?"]')
...
df.add_system_transition(State.PROMPT_oolgoalalign_err3,State.PROMPT_oolstressfr3,r'[!"It sounds like you already have a time management strategy. That is a great place to start!"#school_n4_lil"How often do you find"#help_ss"overwhelming?"]')
...
df.add_system_transition(State.PROMPT_oolgoalalign_no3,State.PROMPT_oolstressfr3,r'[!"I am quite spontaneous too. That makes us flexible and creative!"#school_n4_lil"How often do you find"#help_ss"overwhelming?"]')
#stressfreq->help1->help2->onlinelearning1->onelinelearning2->studyspot1->studyspot2->destress
...
df.add_system_transition(State.PROMPT_oolstressfr_often3,State.PROMPT_oolhelp_person3,r'[!"It is good that you are becoming increasingly resilient. Resiliency is the key to success!"#school_n2_often"Anyone you can ask for advice on"#help_ss"?"]')
df.add_system_transition(State.PROMPT_oolstressfr_sometimes3,State.PROMPT_oolhelp_person3,r'[!"A little stress once in a while can make your life more productive. That is the case for me."#school_n2_sometimes"Anyone you can ask for help or advice on"#help_ss"?"]')
df.add_system_transition(State.PROMPT_oolstressfr_never3,State.PROMPT_oolhelp_person3,r'[!"For real"#school_n2_never"?"#help_ss"must matter a lot to you.Anyone you can ask for help or advice on"#help_ss"?"]')
df.set_error_successor(State.PROMPT_oolstressfr3,State.PROMPT_oolstressfr_err3)
df.add_system_transition(State.PROMPT_oolstressfr_err3,State.PROMPT_oolhelp_person3,r'[!"Even though this is totally a cliche, I still want to remind you that what does not kill you makes you stronger!"#school_n2_sometimes"Anyone you could ask to help you on"#help_ss"?"]')
...
df.add_system_transition(State.PROMPT_oolonline_bad3,State.PROMPT_oolonline_reasonbad3,r'[!"Online education because is much better than nothing though."#school_e2_online1_dislike"What do you not like about it?"]')
...
df.add_system_transition(State.PROMPT_oolzoom_yes3,State.PROMPT8_1,r'[!"I guess"#school_e3_studyspot2_zoom"we are quite similar in our study habits. I recently feel so stressed about many things. What do you do to destress during quarantine?"]')
...
'''SINGLE SAV'''
df.add_system_transition(State.SINGLEo1, State.SINGLE01, r'[!"Whenever I am stressed about being single, I think about how being in a relationship is even more stressful. How long have you been single?"]')
...
df.add_system_transition(State.SINGLE0_short1, State.SINGLE11, r'[!"Someone is more than ready to move on from the previous relationship. I am happy for you. How often are you feeling stressed about being single?"]')
df.add_system_transition(State.SINGLE0_mid1, State.SINGLE11, r'[!"If you end up meeting the love of your live, it will be worth the wait though. How often are you feeling stressed about being single?"]')
df.add_system_transition(State.SINGLE0_long1, State.SINGLE11, r'[!"Staying single for that long is not easy. Whoever becomes the love of your life one day will be so proud of you. How often are you feeling stressed about being single?"]')
...
df.add_system_transition(State.SINGLE1_often1, State.SINGLE21, r'[!"There are so many things to be stressed about, and you choose to be stressed about being single? Just kidding. Do you think you have a high standard?"#high_n""]')
df.add_system_transition(State.SINGLE1_sometimes1, State.SINGLE21, r'[!"Perhaps you are not even sure if a romantic relationship is what you really need right now. Do you think you have a high standard?"#mid_n""]')
...
df.add_system_transition(State.SINGLE2_yes1, State.SINGLE31, r'[!"Lies.When the love of you life shows up in front of you, you will forget all about your standard! What do you like to do during quarantine?"]')
df.add_system_transition(State.SINGLE2_no1, State.SINGLE31, r'[!"Why not focus on yourself more! A person with self confidence is more attractive. What do you like to do during quarantine?"]')
...
df.add_system_transition(State.SINGLE0_ERR1, State.SINGLE11, r'[!"It is okay. I am single too! Maybe we should date! How often are you feeling stressed about being single?"]')
...
df.add_system_transition(State.SINGLE2_ERR1, State.SINGLE31, r'[!"In that case, you should focus more on yourself! What do you like to do during quarantine?"]')
df.add_system_transition(State.SINGLE3_ERR1, State.COVID2, r'[!"That sounds very interesting! I should try that next time when I have less homework. Are you also taking online classes?"]')
'''BREAK UP SAV'''
...
df.add_system_transition(State.BREAKUP0_short1, State.BREAKUP11, r'[!"Perhaps you are just not so compatible with each other! Did this breakup happen because of the coronavirus situation? "]')
df.add_system_transition(State.BREAKUP0_mid1, State.BREAKUP11, r'[!"You must have made so many unforgettable memories together. Did this breakup happen because of coronavirus situation?"]')
df.add_system_transition(State.BREAKUP0_long1, State.BREAKUP11, r'[!"Sometimes you just gotta end a story and start another one! Did this breakup happen because of the coronavirus situation?"]')
...
df.add_system_transition(State.BREAKUP1_01, State.BREAKUP21, r'[!"So the coronavirus is innocent. A healthy relationship is said to be composed of intimacy, passion, and commitment. Which one do you think yours was lacking?"]')
...
df.add_system_transition(State.BREAKUP2_intimacy1, State.BREAKUP31, r'[!"A relationship without intimacy is no longer romantic. Now you know what to do in your next relationship! Do you want to get back together with your ex?"]')
df.add_system_transition(State.BREAKUP2_passion1, State.BREAKUP31, r'[!"This reminds me of how my ex and I split up because we knew each other too well. Do you want to get back together with your ex?"]')
df.add_system_transition(State.BREAKUP2_commitment1, State.BREAKUP31, r'[!"Relationships without commitment are not worth sustaining anyway. Have you thought about getting back together with your ex?"]')
...
df.add_system_transition(State.BREAKUP3_yes1, State.BREAKUP41, r'[!"If it does not work out this time, it probably will not in the future. But it is your choice. Dont forget to love yourself more. What activity do you like to do during quarantine?"]')
df.add_system_transition(State.BREAKUP3_no1, State.BREAKUP41, r'[!"You deserve someone better! Time to focus on self development. What activity do you like to do during quarantine?"]')
...
df.add_system_transition(State.COVID0_ERR1, State.COVID1, r'[!"If a virus can ruin your relationship, then this relationship is probably not worth maintaining. What activity do you do to relax during quarantine?"]')
...
df.add_system_transition(State.BREAKUP0_ERR1, State.BREAKUP11, r'[!"Did this breakup happen because of the coronavirus situation?"]')
df.add_system_transition(State.BREAKUP1_ERR1, State.BREAKUP21, r'[!"So you cannot blame it on the virus. A healthy relationship is said to be composed of intimacy, passion, and commitment. Which one do you think yours was lacking?"]')
df.add_system_transition(State.BREAKUP2_ERR1, State.BREAKUP31, r'[!"Last year my girlfriend broke up with me because of her insecurity around long distance. And I learned the importance of committment. Just curious, do you want to get back together ?"]')
df.add_system_transition(State.BREAKUP3_ERR1, State.BREAKUP41, r'[!"I think you are ready to move on! Time to focus self development. During quarantine, I really enjoy trying new stuff. What activity do you like to do during quarantine?"]')
df.add_system_transition(State.BREAKUP4_ERR1, State.COVID2, r'[!"Interesting! I should try that next time when I have less homework. Sleeping is my only destress activity recently. Are you also taking online classes?"]')
'''RELATIONSHIP SAV'''
df.add_system_transition(State.ROMANo1, State.ROMAN01, r'[!"Must be nice! How long have you guys been together?"]')
...
df.add_system_transition(State.ROMAN0_short1, State.ROMAN11, r'[!"Still on the honeymoon period? That is so cute. How often do you feel stressed about your relationship?"]')
df.add_system_transition(State.ROMAN0_mid1, State.ROMAN11, r'[!"No wonder. I would be surprised if you have not encountered any issues in your relationship. How often do you feel stressed about your relationship?"]')
df.add_system_transition(State.ROMAN0_long1, State.ROMAN11, r'[!"Oh wow. I am in love with your love story. How often do you feel stressed about your relationship?"]')
...
df.add_system_transition(State.ROMAN2_01, State.ROMAN31, r'[!"I guess the coronavirus is innocent. Healthy relationships are said to be composed of intimacy, passion, and commitment. Which one do you think yours is lacking?"]')
...
df.add_system_transition(State.ROMAN2_ERR1, State.ROMAN31, r'[!"I guess the coronavirus is innocent. Let me try to make use of what I learned from my psychology class. The theory of love suggests that love in composed by intimacy, passion, and commitment. Which one do you think yours is lacking?"]')
...
df.add_system_transition(State.ROMAN5_ERR1, State.COVID2, r'[!"I should try that next time. Dont judge me. Sleeping is my only destress activity. Are you also taking online classes?"]')
df.add_system_transition(State.COVID01, State.COVID1, r'[!"Oh...I am guessing this stress is coming from the fact that you cannot see each other. Not able to see my friends and talk about how our life suck is stressing me out. But doing some fun activities help me relax a lot. What activity do you like to do during quarantine?"]')
...
'''BREAK UP AGR'''
df.add_system_transition(State.BREAKUP_AGG, State.BREAKUP0, r'[!"Oh I am sorry. Must be so hardbreaking for you. How long had you guys been together?"]')
...
df.add_system_transition(State.BREAKUP3_yes, State.BREAKUP4, r'[!"I wish you the best of luck! However, dont forget to love yourself. During quarantine, I really enjoy trying new stuff. What activity do you like to do during quarantine?"]')
df.add_system_transition(State.BREAKUP3_no, State.BREAKUP4, r'[!"I think you are ready to move on! Time to focus on self-development, and dont forget to love yourself more. During quarantine, I really enjoy trying new stuff. What activity do you like to do during quarantine?"]')
...
df.add_system_transition(State.BREAKUP3_ERR, State.BREAKUP4, r'[!"I think you are ready to move on! Time to focus self-development, and dont forget to love yourself more. During quarantine, I really enjoy trying new stuff. What activity do you like to do during quarantine?"]')
...
df.add_system_transition(State.SINGLE2_ERR, State.SINGLE3, r'[!"I was once desperate for a relationship. After I gave up trying, it came to me unexpectedly. Stange right? What do you do to relax during quarantine?"]')
...
df.add_system_transition(State.COVID0, State.COVID1, r'[!"I must be hard when you are so uncertain about whether your relationship will stay as strong as it is before quarantine started. What activity do you do to relax during quarantine?"]')
...
df.add_system_transition(State.SINGLE0_long1, State.SINGLE11, r'[!"Hey its okay! Having a girlfriend or boyfriend is not as fun as you thought. How often are you feeling stressed about being single?"]')
df.add_user_transition(State.SINGLE11, State.SINGLE1_often1, r'<{[!#ONT(ontoften)],/(?:\s|^)(((once|twice|thrice|three\stimes|four\stimes|five\stimes|1\stime|2\stimes|3\stimes|4\stimes|5\stimes)\s(every|per|a)(\sone|\s1|\stwo|\s2|\sthree|\s3|\sfour|\s4|\sfive|\s5|\sother|\ssix|\s6|\s7|\sseven|\seight|\s8|\s9|\snine|\sten|\s10)?\s(second+s?|sec+s?|min+s?|minute+s?|hour+s?|hr+s?|day+s?))|((once|twice|thrice|three\stimes|four\stimes|five\stimes|1\stime|2\stimes|3\stimes|4\stimes|5\stimes)\s(every|per|a)(\sone|\s1|\stwo|\s2|\sthree|\s3|\sother)?\s(week+s?))|((three\stimes|thrice|four\stimes|five\stimes|six\stimes|seven\stimes|3\stimes|4\stimes|5\stimes|6\stimes|7\stimes)\s(every|per|a)(\sone|\s1|\stwo|\s2|\sthree|\s3|\sother)?\s(month+s?))|((twice|two\stimes|2\stimes)\s(every|per|a)(\sone)?\s(month)))(?:\s|,|\.|$)/}>')
df.add_user_transition(State.SINGLE11, State.SINGLE1_sometimes1, r'<{[!#ONT(ontsometimes)],/(?:\s|^)(((once|one\stime|two\stimes|twice|three\stimes|thrice|four\stimes|five\stimes|1\stime|2\stimes|3\stimes|4\stimes|5\stimes)\s(every|per|a)(\sone|\s1|\stwo|\s2|\sthree|\s3|\sfour|\s4|\sfive|\s5|\ssix|\s6|\sten|\s10|\sother)?\s(semester+s?|term+s?|quarter+s?|year+s?|decade+s?))|((once|1\stime|one\stime)\s(every|per|a)(\sone|\s1|\stwo|\s2|\sthree|\s3|\sfour|\s4|\sfive|\s5|\ssix|\s6|\sother)?\s(month+s?))|((once|1\stime|2\stimes|twice|thrice|3\stimes|three\stimes|one\stime|four\stimes|4\stimes)\s(every|a|per)(\sthree|\s3|\sfour|\s4|\sfive|\s5|\ssix|\s6|\sseven|\s7|\seight|\s8|\sten|\s10)\s(month+s?)))(?:\s|,|\.|$)/}>')
df.add_user_transition(State.SINGLE11, State.SINGLE1_never1, r'<{[!#ONT(ontnever)]}>')
...
df.add_user_transition(State.BREAKUP31, State.BREAKUP3_yes1, r'<[!#ONT(ontyes)]>')
df.add_user_transition(State.BREAKUP31, State.BREAKUP3_no1, r'<[!#ONT(ontno)]>')
df.add_system_transition(State.BREAKUP3_yes1, State.BREAKUP41, r'[!"I wish you the best of luck! However, dont forget to love yourself. During quarantine, I really enjoy trying new stuff. What activity do you like to do during quarantine?"]')
df.add_system_transition(State.BREAKUP3_no1, State.BREAKUP41, r'[!"I think you are ready to move on! Time to focus on self-development, and dont forget to love yourself more. During quarantine, I really enjoy trying new stuff. What activity do you like to do during quarantine?"]')
df.add_user_transition(State.BREAKUP41, State.COVID1_game, r'<[!#ONT(ontgames)]>')
df.add_user_transition(State.BREAKUP41, State.COVID1_food, r'<[!#ONT(ontfood)]>')
df.add_user_transition(State.BREAKUP41, State.COVID1_video, r'<[!#ONT(ontreadwatch)]>')
df.add_user_transition(State.BREAKUP41, State.COVID1_socialApp, r'<[!#ONT(ontsocialApp)]>')
...
df.add_user_transition(State.BREAKUP41, State.COVID1_music, r'<[!#ONT(ontmusic)]>')
df.set_error_successor(State.COVID01,State.COVID0_ERR1)
df.add_system_transition(State.COVID0_ERR1, State.COVID1, r'[!"If a virus can destroy your relationship, then you probably do not want this relationship. Doing some fun activities might help you relax! What activity do you like to do during quarantine?"]')
df.set_error_successor(State.BREAKUP01, State.BREAKUP0_ERR1)
df.set_error_successor(State.BREAKUP11, State.BREAKUP1_ERR1)
df.set_error_successor(State.BREAKUP21, State.BREAKUP2_ERR1)
df.set_error_successor(State.BREAKUP31, State.BREAKUP3_ERR1)
...
df.add_system_transition(State.BREAKUP3_ERR1, State.BREAKUP41, r'[!"I think you are ready to move on! Time to focus self-development, and dont forget to love yourself more. During quarantine, I really enjoy trying new stuff. What activity do you like to do during quarantine?"]')
...
df.add_system_transition(State.ROMAN3_ERR1, State.ROMAN41, r'[!"Oh I see. Last year I felt like my girlfriend and I are losing passion because of long distance. Guess what safe our relationship? A lof of s...I think you know the answer. Have you ever talked about your stress with your boyfriend or girlfriend?"]')
df.add_system_transition(State.ROMAN4_ERR1, State.ROMAN51, r'[!"You should have a serious conversation with him or her! Telling each other whats on your mind can strengthen your relationship. You should do something to releive your stress. What activity do you like to do during quanrantine?"]')
df.add_system_transition(State.ROMAN5_ERR1, State.COVID2, r'[!"That sounds super interesting! I should try that nex time. I guess eating is my only destress activity... Are you also taking online classes?"]')
df.add_system_transition(State.COVID01, State.COVID1, r'[!"Hey I have faith in your love! Perhaps the quarantine situation will help you guys become an even stronger couple than before. What activity do you do to relax during quarantine?"]')
...
df.add_system_transition(State.COVID1_food, State.COVID2, r'[!"Cook, eat, sleep, taking online classes, that is bascially sums up my life now. Are you also taking online classes?"]')
...
df.add_system_transition(State.COVID1_class, State.COVID3, r'[!"Me too! But I do not think taking online classes is a fun...How do you feel about this transition to remote learning?"]')
df.add_system_transition(State.COVID2_yes, State.COVID3, r'[!"Nice! Feel so good to know someone is also suffering with me. How do you feel about this transition to remote learning?"]')
...
df.add_system_transition(State.COVID2_no, State.COVIDEND, r'[!"I am jealous of you! Taking online classes is awful. I have a class in 5 minutes. Have to go. So nice talking to you. Have a nice day!"]')
...
df.add_system_transition(State.COVID2_ERR, State.COVID3, r'[!"Nice! Good to know someone is also suffering with me. How do you feel about this transition to remote learning?"]')
