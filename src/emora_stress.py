...
df.add_system_transition(State.PROMPT8_music1, State.PROMPT9_1,r'[!"Of course, listening to music is so stress relieving, right? I love listening to pop music."]')
...
df.add_system_transition(State.PROMPT8_readwatch1, State.PROMPT9_1,r'[!"I love staying indoors when I am stressed too. It really helps me stay calm."]')
df.add_user_transition(State.PROMPT8_1, State.PROMPT8_onlinesocial1, r'<$activity={[!#ONT(ontonlinesocial)]}>')
df.add_system_transition(State.PROMPT8_onlinesocial1, State.PROMPT9_1,r'[!"Guess how many hours I spend on social media every day. 5 hours! I bet you spend even more time than me."]')
df.add_user_transition(State.PROMPT8_1, State.PROMPT8_social1, r'<$activity={[!#ONT(ontsocial)]}>')
df.add_system_transition(State.PROMPT8_social1, State.PROMPT9_1,r'[!"You are such a social butterfly! Do you have lots of friends?"]')
...
df.add_system_transition(State.BREAKUP3_ERR2, State.BREAKUP42, r'[!"Time to focus on self development then! During quarantine, I really enjoy trying new stuff. What activity do you like to do during quarantine?"]')
...
df.add_system_transition(State.BREAKUP3_no, State.BREAKUP4, r'[!"Time to focus on self development then! Dont forget to love yourself more. During quarantine, I really enjoy trying new stuff. What activity do you like to do during quarantine?"]')
...
df.add_system_transition(State.BREAKUP3_ERR, State.BREAKUP4, r'[!"I think you are ready to move on! Time to focus on self development, and dont forget to love yourself more. During quarantine, I really enjoy trying new stuff. What activity do you like to do during quarantine?"]')
...
df.add_system_transition(State.BREAKUP3_ERR1, State.BREAKUP41, r'[!"Time to focus on self development! Dont forget to love yourself more. During quarantine, I really enjoy trying new stuff. What activity do you like to do during quarantine?"]')
